...
public class TransactionServiceTest {
  ...
  public void createPurchaseTransactionSuccessfully() {
    ...
    TransactionRequest transactionRequest =
        TransactionMock.createTransactionRequest(OperationType.PURCHASE, amount);
  ...
  public void createPurchaseTransactionUnsuccessfully() {
    ...
    assertEquals(
        String.format(
            ...
            OperationType.PURCHASE, OperationType.PURCHASE.getId(), amount),
  ...
  public void createInstallmentPurchaseTransactionSuccessfully() {
    ...
    TransactionRequest transactionRequest =
        TransactionMock.createTransactionRequest(OperationType.INSTALLMENT_PURCHASE, amount);
    Transaction transaction =
        TransactionMock.createTransaction(OperationType.INSTALLMENT_PURCHASE, amount);
  ...
  public void createInstallmentPurchaseTransactionUnsuccessfully() {
    ...
    assertEquals(
        String.format(
            "The operation [%s] with id [%s] cannot have positive amount [%s].",
            OperationType.INSTALLMENT_PURCHASE, OperationType.INSTALLMENT_PURCHASE.getId(), amount),
        businessException.getMessage());
  }
  ...
  public void createWithdrawTransactionSuccessfully() {
    BigDecimal amount = BigDecimal.valueOf(-11.23);
    TransactionRequest transactionRequest =
        TransactionMock.createTransactionRequest(OperationType.WITHDRAWAL, amount);
  ...
  public void createWithdrawTransactionUnsuccessfully() {
    ...
    assertEquals(
        String.format(
            "The operation [%s] with id [%s] cannot have positive amount [%s].",
            OperationType.WITHDRAWAL, OperationType.WITHDRAWAL.getId(), amount),
        businessException.getMessage());
  }
  ...
  public void createPaymentTransactionSuccessfully() {
    ...
    Transaction transaction =
        TransactionMock.createTransaction(OperationType.PAYMENT, BigDecimal.valueOf(10.23));
  ...
  public void createPaymentTransactionUnsuccessfully() {
    ...
    TransactionRequest transactionRequest =
        TransactionMock.createTransactionRequest(OperationType.PAYMENT, amount);
    ...
    assertEquals(
        String.format(
            ...
            OperationType.PAYMENT, OperationType.PAYMENT.getId(), amount),
        businessException.getMessage());
  }
